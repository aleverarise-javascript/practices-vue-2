...
export default {
	...
	mounted(){
		...
		axios.get('http://localhost/dashboard/Cursos/VueJS/VersionPaga/4-Web-SPA/api-webApp/restaurantes-api.php/restaurante/'+this.id)
	  			.then((respuesta) => {
	...
	methods:{
		guardarRestaurante(){
			...
			axios.post('http://localhost/dashboard/Cursos/VueJS/VersionPaga/4-Web-SPA/api-webApp/restaurantes-api.php/update-restaurante/'+id, params)
				.then((respuesta) => {
